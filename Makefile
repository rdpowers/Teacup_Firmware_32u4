...
SOURCES  = $(PROGRAM).c gcode_parse.c gcode_process.c dda_split.c dda.c
SOURCES += dda_maths.c dda_queue.c timer.c temp.c sermsg.c watchdog.c debug.c
SOURCES += sersendf.c heater.c analog.c intercom.c pinio.c clock.c home.c crc.c
SOURCES += delay.c serial.c usb_serial.c
